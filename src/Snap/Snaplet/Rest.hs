...
------------------------------------------------------------------------------
-- | Stores the given resources.  Note that this operation is non-atomic.
storeResources :: MonadSnap m => (par -> m ()) -> [par] -> m ()
storeResources store' = mapM_ store'
